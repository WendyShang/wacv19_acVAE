...
--
-- NOTE: THE NUMBER OF ATTRIBUTE IS HARDCODED TO BE 40 HERE. 
...
function DataLoader:run()
   ...
   size = math.floor(size/batchSize)*batchSize
   perm = perm[{{1,size}}]
      ...
      while idx <= size and threads:acceptsjob() do
         ...
         threads:addjob(
            function(indices, nCrops)
               ...
               local target = torch.Tensor(sz, 40)
