...
local function createModel(opt)
   ...
   return {encoder, encoder_conv, from_rgb_encoder, decoder, decoder_conv, to_rgb, var_encoder, var_decoder, prior, from_rgb, disc_conv, gan_feature, recon, disc, sampling_z}, {KLD, ReconCriterion, BCECriterion, ReconZCriterion}
end
